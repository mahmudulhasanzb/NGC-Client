      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 rounded-2xl border border-border/80 bg-card p-6 shadow-xs">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/"
            target="_blank"
            className="inline-flex items-center gap-2 rounded-xl border border-border bg-background px-4 py-2.5 text-xs font-semibold text-foreground transition-colors hover:bg-secondary hover:text-primary cursor-pointer shadow-2xs"
          >
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {cards.map((card) => {
          ...
          return (
            <div
              key={card.title}
              className="group relative flex flex-col justify-between rounded-2xl border border-border bg-card p-5 shadow-2xs transition-all duration-200 hover:-translate-y-0.5 hover:border-primary/40 hover:shadow-xs"
            >
              <div>
      ...
      <div className="grid gap-6 lg:grid-cols-12">
        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-xs lg:col-span-7">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <Link
              href="/dashboard/notices"
              className="flex items-center gap-3 rounded-xl border border-border/80 bg-secondary/30 p-3.5 transition-all hover:border-primary/40 hover:bg-secondary/60 cursor-pointer"
            >
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-amber-500/10 text-amber-500">
                <PlusCircle className="h-4 w-4" />
              </div>
              <div className="min-w-0 flex-1">
                <div className="font-serif text-xs font-bold text-foreground truncate">
                  Publish Notice
                </div>
          ...
          <div>
            ...
            <dl className="space-y-2.5 text-xs">
              <div className="flex justify-between border-b border-border/50 pb-2">
                ...
                <dd className="font-mono font-bold text-foreground">129524</dd>
              </div>
              <div className="flex justify-between border-b border-border/50 pb-2">
                <dt className="text-muted-foreground">College Code (BISE)</dt>
                <dd className="font-mono font-bold text-foreground">1301</dd>
              </div>
              <div className="flex justify-between border-b border-border/50 pb-2">
                <dt className="text-muted-foreground">National University Code</dt>
                <dd className="font-mono font-bold text-foreground">1706</dd>
              </div>
              <div className="flex justify-between border-b border-border/50 pb-2">
